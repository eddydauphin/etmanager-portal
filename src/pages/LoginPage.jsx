      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-600 rounded-xl mb-4">
            <span className="text-2xl font-bold text-white">E&T</span>
          </div>
          <h1 className="text-2xl font-bold text-gray-900">E&T Manager</h1>
          <p className="text-gray-600 mt-1">Competency & Training Management</p>
          <p className="text-sm text-gray-500 mt-1">by Foodek Consulting</p>
        </div>
